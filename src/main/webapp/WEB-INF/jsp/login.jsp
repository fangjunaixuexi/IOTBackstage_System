...
<body>
	...
	<div id="contPar" class="contPar">
		<div id="page1" style="z-index: 1;">
			<div class="title0">大智慧平台</div>
			<div class="title1">环境、定位、大数据</div>
			<div class="imgGroug">
				<ul>
	...
	<div class="tyg-div-denglv">
		<div class="tyg-div-form">
			<form id="userForm">
				...
				<div style="margin: 5px 0px;">
					<input type="text" placeholder="请输入密码..." name="userpassword" />
				</div>
				<%-- <div style="margin: 5px 0px;">
					<input type="text" style="width: 150px;" placeholder="请输入验证码..." />
					<img src="${pageContext.request.contextPath }/images/1.png" style="vertical-align: bottom;" alt="验证码" />
				</div> --%>
	...
	$(function() {
		$("#userForm").validate({
							...
							messages : {
								username : "用户不能为空",
								userpassword : {required : "请输入密码",minlength : "密码长度不能小于 5 个字母"
								}
							},
							submitHandler : function() {
								//提交Ajax
								 $.ajax({
											...
											dataType : "text",
											type : "post",
											url : "${pageContext.request.contextPath}/user/toVerification",
