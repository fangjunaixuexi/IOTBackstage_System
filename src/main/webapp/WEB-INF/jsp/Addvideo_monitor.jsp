						...
						<div class="navbar-inner">
							<ul class="breadcrumb">
								...
								<li><a
									...
									<span class="divider">/</span></li>
								<li><a href="#">添加视频监控设备</a> <span class="divider">/</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="block-content collapse in">
						<div class="span12">
							<form class="form-horizontal"
								action="${pageContext.request.contextPath }/user/toinsertvideo_monitor"
								method="post" accept-charset="UTF-8" onsubmit="return check()">
								<fieldset>
									<legend>添加视频监控设备数据</legend>
									...
									<div class="control-group success">
										...
										<div class="controls">
											<input type="text" name="vuser_name" >
											<span class="help-inline">-</span>
										</div>
									</div>
									<div class="control-group success">
...
<script type="text/javascript">
		function check() {
			...
			if (port == "" || port == null) {
				document.getElementById("checktext1").innerHTML = "设备端口号不能为空 ";
				check = false;
			} else {
				flag = reg.test(port);
				if (!flag) {
					document.getElementById("checktext1").innerHTML = "设备端口号只能为数字";
					check = false;
				} else {
