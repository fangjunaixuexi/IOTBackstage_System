						...
						<div class="navbar-inner">
							...
							<li><a
								...
								<li><a
									...
									<span class="divider">/</span></li>
								<li><a href="#">添加安全帽设备</a> <span class="divider">/</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="block-content collapse in">
						<div class="span12">
							<form class="form-horizontal"
								action="${pageContext.request.contextPath }/user/toinsertSafetyHat"
								...
								<fieldset>
									...
									<div class="control-group success">
										...
										<div class="controls">
											<input type="text" name="hat_name" value="null"> <span
												class="help-inline">-</span>
										</div>
									</div>
									<div class="control-group success">
										<label class="control-label" for="selectError">安全帽所属工地</label>
										<div class="controls">
										...
										<div class="control-group success">
										<label class="control-label" for="selectError">安全帽所属工组</label>
										<div class="controls">
