			...
			<div class="span10" id="content">
					...
					<div class="navbar">
						<div class="navbar-inner">
							<ul class="breadcrumb">
								...
								<li><a href="#">登录日志数据</a> <span class="divider">/</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">logindate dataTables</div>
							<div align="right">
							<a href="${pageContext.request.contextPath }/user/todeletelogindate"><button>全部清除</button></a>
						</div>
					</div>
					<div class="block-content collapse in">
						<div class="span12">
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<tbody>
									<c:forEach items="${loginSession }" var="login">
										<tr>
											<td style="text-align: center;">${login.username}</td>
											<td style="text-align: center;">${login.logintime}</td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
