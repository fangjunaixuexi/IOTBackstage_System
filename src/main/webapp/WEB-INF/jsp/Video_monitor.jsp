			...
			<div class="span10" id="content">
					...
					<div class="navbar">
						<div class="navbar-inner">
							<ul class="breadcrumb">
								...
								<li><a href="#">视频监控设备</a> <span class="divider">/</span></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">Video_monitor dataTables</div>
						<div align="right">
							<a
								href="${pageContext.request.contextPath }/user/toaddVideo_monitor"><button>添加视频监控设备</button></a>
						</div>
					</div>
					<div class="block-content collapse in">
						<div class="span12">
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<thead>
									<tr>
										<th style="text-align: center;">视频IP</th>
										<th style="text-align: center;">视频端口</th>
										<th style="text-align: center;">视频监控用户</th>
										<th style="text-align: center;">用户密码</th>
										<th style="text-align: center;">视频所属工地</th>
										<th style="text-align: center;">操作</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${videoListSession }" var="video">
										<tr>
											<td style="text-align: center;">${video.ip}</td>
											<td style="text-align: center;">${video.port}</td>
											<td style="text-align: center;">${video.vuser_name}</td>
											<td style="text-align: center;">${video.vpassword}</td>
											<td style="text-align: center;">${video.belong}</td>
											<td style="text-align: center;"><a
												href="${pageContext.request.contextPath }/user/toeditVideo_monitor?v_id=${video.v_id}">修改</a>|<a
												href="${pageContext.request.contextPath }/user/todeleteVideo_monitor?v_id=${video.v_id}">删除</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
