			...
			<div class="span10" id="content">
					...
					<div class="navbar">
						<div class="navbar-inner">
							<ul class="breadcrumb">
								...
								<li><a
									href="${pageContext.request.contextPath }/user/tovideo_monitor">视频监控设备</a>
									<span class="divider">/</span></li>
								<li><a href="#">修改视频监控设备</a> <span class="divider">/</span>
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">修改视频设备数据</div>
					</div>
					<div class="block-content collapse in">
						<div class="span12">
							<form class="form-horizontal"
								action="${pageContext.request.contextPath }/user/toupdatevideo_monitor"
								method="post" accept-charset="UTF-8" onsubmit="return check()">
								<fieldset>
									<legend>修改视频设备信息</legend>
									<div class="control-group">
										<label class="control-label" for="focusedInput"
											style="text-align: center;">视频监控设备id</label>
										<div class="controls">
											<input class="input-xlarge focused" name="v_id" id="v_id" readonly="readonly"
												type="text" value="${Onevideo_monitorSession.v_id }"> 
										</div>
									</div>
												<div class="control-group">
										<label class="control-label" for="focusedInput"
											style="text-align: center;">视频IP</label>
										<div class="controls">
											<input class="input-xlarge focused" name="ip" id="ip"
												type="text" value="${Onevideo_monitorSession.ip }"> <span class="help-inline">*</span>
												<span id="checktext1"></span>
										</div>
									</div>
									<div class="control-group success">
										<label class="control-label" for="inputError">视频端口</label>
										<div class="controls">
											<input type="text" name="port"   value="${Onevideo_monitorSession.port }">
											<span class="help-inline">-</span>
										</div>
									</div>
									<div class="control-group success">
										<label class="control-label" for="inputError">视频监控用户</label>
										<div class="controls">
											<input type="text" name="vuser_name"  value="${Onevideo_monitorSession.vuser_name }">
											<span class="help-inline">-</span>
										</div>
									</div>
									<div class="control-group success">
										...
										<div class="controls">
											<input type="text" name="vpassword"  value="${Onevideo_monitorSession.vpassword }" >
											<span class="help-inline">-</span>
										</div>
									</div>
									<div class="control-group success">
										...
										<div class="controls">
											<select name="c_id">
												...
												<option value="${oneConstruction_siteSession.c_id}" selected="selected">${oneConstruction_siteSession.c_name}</option>
