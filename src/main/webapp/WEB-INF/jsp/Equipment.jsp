				...
				<div class="navbar">
						<div class="navbar-inner">
							<ul class="breadcrumb">
								...
								<li><a href="${pageContext.request.contextPath }/user/toindex">首页</a> <span class="divider">/</span></li>
									  <li>
	                                        <a href="#">环境监控设备</a> <span class="divider">/</span>	
	                                    </li>
							</ul>
						</div>
					</div>
					...
					<div class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">Equipment dataTables</div>
								<div align="right"><a href="${pageContext.request.contextPath }/user/toaddequipment"><button>添加环境监控设备</button></a></div>
						</div>
								...
								<table cellpadding="0" cellspacing="0" border="0"
									...
									<thead>
										<tr>
											...
											<th style="text-align: center;">设备序列号</th>
											<th style="text-align: center;">设备所属</th>
											<th style="text-align: center;">操作</th>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${equipmentSession }" var="equipment">
											<tr>
												<td style="text-align: center;">${equipment.enviromental_id}</td>
												<td style="text-align: center;">${equipment.serial_number}</td>
												<td style="text-align: center;">${equipment.belong}</td>
												<td style="text-align: center;"><a
													href="${pageContext.request.contextPath }/user/toeditequipment?id=${equipment.id}">修改</a>|<a
													href="${pageContext.request.contextPath }/user/todeleteequipment?id=${equipment.id}">删除</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
