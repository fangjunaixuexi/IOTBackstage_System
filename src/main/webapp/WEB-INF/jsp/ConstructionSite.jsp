			...
			<div class="span10" id="content">
					...
					<div class="navbar">
						<div class="navbar-inner">
							<ul class="breadcrumb">
								...
								<li><a href="#">工地管理</a> <span class="divider">/</span></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="block">
					<div class="navbar navbar-inner block-header">
						<div class="muted pull-left">ConstructionSite dataTables</div>
						<div align="right">
							<a href="${pageContext.request.contextPath }/user/toaddConstructionSite"><button>添加工地</button></a>
						</div>
					</div>
					<div class="block-content collapse in">
						<div class="span12">
							...
							<table cellpadding="0" cellspacing="0" border="0"
								...
								<thead>
									<tr>
										<th style="text-align: center;">工地id</th>
										<th style="text-align: center;">工地名称</th>
										<th style="text-align: center;">工地编号</th>
										<th style="text-align: center;">工地所属</th>
										<th style="text-align: center;">操作</th>
									</tr>
								</thead>
								<tbody>
									<c:forEach items="${listConstructionSiteSession }" var="construction">
										<tr>
											<td style="text-align: center;">${construction.c_id}</td>
											<td style="text-align: center;">${construction.regionname}</td>
											<td style="text-align: center;">${construction.regionid}</td>
											<td style="text-align: center;">${construction.fathername}</td>
											<td style="text-align: center;"><a
												href="${pageContext.request.contextPath }/user/toeditConstructionSite?c_id=${construction.c_id}">修改</a>|<a
												href="${pageContext.request.contextPath }/user/todeleteConstructionSite?c_id=${construction.c_id}">删除</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
