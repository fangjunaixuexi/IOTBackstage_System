						...
						<div class="navbar-inner">
							<ul class="breadcrumb">
								...
								<li><a
									...
									<span class="divider">/</span></li>
								<li><a href="#">添加环境监控设备</a> <span class="divider">/</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="block-content collapse in">
						<div class="span12">
							<form class="form-horizontal"
								action="${pageContext.request.contextPath }/user/toinsertequipment"
								method="post" accept-charset="UTF-8" onsubmit="return check()">
								<fieldset>
									<legend>添加监控数据</legend>
									...
									<div class="control-group success">
										<label class="control-label" for="inputError">设备序列号</label>
										<div class="controls">
											<input type="text" name="serial_number" value="null">
											<span class="help-inline">-</span>
										</div>
									</div>
									<div class="control-group success">
										<label class="control-label" for="selectError">设备所属</label>
										<div class="controls">
											<select name="c_id">
