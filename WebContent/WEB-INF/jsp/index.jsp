...
<!-- Morris Chart Styles-->
<link href="${pageContext.request.contextPath }/js/morris/morris-0.4.3.min.css" rel="stylesheet" />
<!-- Custom Styles-->
		...
		<div class="sidebar-collapse">
			<ul class="nav" id="main-menu">
				...
				<li><a class="active-menu" href="index.html"><i
						class="fa fa-dashboard"></i>数据信息</a></li>
				<li><a href="ui-elements.html"><i class="fa fa-desktop"></i>
						UI Elements</a></li>
				<li><a href="chart.html"><i class="fa fa-bar-chart-o"></i>
						Charts</a></li>
				<li><a href="${pageContext.request.contextPath }/user/totab-panel"><i class="fa fa-qrcode"></i>
						Tabs & Panels</a></li>

				<li><a href="${pageContext.request.contextPath }/user/totable"><i class="fa fa-table"></i>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				...
				<div class="row">
					<div class="col-md-12">
						<h1 class="page-header">
							数据信息 <small>Summary of your App</small>
						</h1>
						<ol class="breadcrumb">
							<li><a href="#">Home</a></li>
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-12 col-xs-12">
						<div
							class="panel panel-primary text-center no-boder bg-color-red red">
